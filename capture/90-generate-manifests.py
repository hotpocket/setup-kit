...
DROPS = {  # pkg: reason
    ...
    "pulseaudio": "host-decided: 26.04 runs PipeWire (pipewire-audio); this would REMOVE it",
    "pulseaudio-module-bluetooth": "with pulseaudio",
    "pulseaudio-equalizer": "with pulseaudio (use easyeffects)",
...
# exiftool: a CLI metadata tool, not a library. apt's 'perl' section would
# bury it in libs-review (never installed); pin it to the default-ON CLI set.
OVERRIDES["libimage-exiftool-perl"] = "cli-system"
